...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans text-gray-900">
      {/* Left Panel: Editor */}
      <div className="w-full md:w-1/2 p-4 border-r bg-zinc-50 flex flex-col h-[50vh] md:h-screen border-zinc-200">
        <h2 className="text-lg font-bold mb-4 flex items-center gap-2 text-zinc-800">
          <Copy className="w-5 h-5" /> Input Workflow
        </h2>
        <textarea
          className="flex-1 w-full p-4 font-mono text-sm bg-white border border-zinc-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent text-zinc-700 placeholder:text-zinc-400"
      ...
      {/* Right Panel: Results */}
      <div className="w-full md:w-1/2 p-4 bg-white h-[50vh] md:h-screen overflow-y-auto">
